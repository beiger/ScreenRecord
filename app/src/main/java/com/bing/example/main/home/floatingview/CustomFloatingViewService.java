...
public class CustomFloatingViewService extends Service implements FloatingViewListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        mFloatingViewManager.setFixedTrashIconImage(R.drawable.ic__video_white_24dp);
        mFloatingViewManager.setActionTrashIconImage(R.drawable.ic_about);
    ...
    private static Notification createNotification(Context context) {
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context, context.getString(R.string.open_permission));
        builder.setWhen(System.currentTimeMillis());
        builder.setSmallIcon(R.mipmap.ic_launcher);
        builder.setContentTitle(context.getString(R.string.open_permission));
        builder.setContentText(context.getString(R.string.open_permission));
        builder.setOngoing(true);
        builder.setPriority(NotificationCompat.PRIORITY_MIN);
        builder.setCategory(NotificationCompat.CATEGORY_SERVICE);

        // PendingIntent作成
        final Intent notifyIntent = new Intent(context, MainActivity.class);
